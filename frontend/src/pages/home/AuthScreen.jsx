...
const AuthScreen = () => {
    ...
    <header className="max-w-6xl mx-auto flex items-center justify-between p-4">
        <img src="/netflix-logo.png" alt="Logo" className="w-52 md:w-52"/>
    ...
    <div className="flex flex-col items-center justify-center text-center py-40 text-white max-w-6xl mx-auto">
        ...
        <form className="flex flex-col md:flex-row gap-4 w-1/2" onSubmit={handleFormSubmit}>
            <input
                type="email"
                className="p-2 flex-1 border border-gray-700 rounded  text-white bg-black/80"
                placeholder="Email Address"
                id="email" value={email} onChange={(e)=>setEmail(e.target.value)}
            />
        <button className=" bg-red-600 rounded hover:bg-red-700 text-white text-xl lg:text-2xl px-2 lg:px-6 py-1 lg:py-2 font-semibold flex justify-center items-center">Get Started
        ...
        <div className="flex max-w-6xl mx-auto items-center justify-center md:flex-row flex-col-reverse px-4 md:px-2">
            ...
            <div className="flex-1 relative">
                <div className="relative">
                    <img src="/stranger-things-lg.png" alt="Strnager thing image" className="mt-4"/>
                    ...
                    <div className="flex items-center gap-2 absolute bottom-5 left-1/2 -translate-x-1/2 bg-black w-3/4 lg:w-1/2 h-24 border border-slate-500 rounded-md px-2">
                        <img src="/stranger-things-sm.png" alt="Strnager thing image" className="h-full"/>
    ...
    <div className="py-10 bg-black text-white">
        <div className="flex max-w-6xl mx-auto items-center justify-center md:flex-row flex-col px-4 md:px-2">
            ...
            <div className="flex-1 text-center md:text-left">
                ...
                <p className="text-lg md:text-xl">Stream unlimited movies and TV shows on your phones,tablets,laptops and TV.</p>
            </div>
            {/* right-side */}
            <div className="flex-1 relative">
