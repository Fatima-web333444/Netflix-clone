...
const WatchPage = () => {
  ...
  if(loading){
    return(
      <div className="min--screen bg-black p-10">
        <WatchPageSkeleton />
      </div>
    )
  }
      ...
      <div className="mx-auto container px-4 py-8 h-full">
        ...
        {trailers.length > 0 && (
          <div className="flex justify-between items-center mb-4">
            ...
            <button
              className={`bg-gray-500/70 hover:bg-gray-500 text-white py-2 px-4 rounded-lg 
        ...
        <div className="aspect-video mb-8 p-2 sm:px-10 md:px-32">
          ...
          {trailers.length === 0 && (
            <h2 className="text-xl text-center mt-5">
              ...
              <span className="text-red-600">{content?.title || content?.name}</span>
            </h2>
          )}
        </div>
        ...
        {similarContent.length > 0 && (
          ...
          >
            ...
            {(
              <>
                <ChevronRight
                  className="absolute top-1/2 -translate-y-1/2 right-2 w-8 h-8 opacity-0 
